/* 
	...
	CM	022223	Changed BILL_THROUGH_DATE and NEXT_BILLING_DATE to date data type
    CM  030723  Moved AGR_OPP_ID to a CASE statement instead of a WHERE statement
    CM  032723  changing to old Oracle Table - INTFUSER.XXKT_SIEBEL_ELIG_ORD_MIG_2
                commented out BILL_THROUGH_DATE and NEXT_BILLING_DATE field as it is not in old table
    CM  032723  reverted change above
    KB  033023  added AGR_MY_DURATION from siebel and Subscription ID from Oracle dataset
    JZ  040123  Removed date casting as it is no longer needed.
    KB  041723  Changed case statement for AGR_INV_PRINTER
*/
...
T1.AGR_INV_PRINTER,
  CASE
  WHEN AGR_INV_PRINTER = 'PortalEMEA' THEN 'PortalEMEAI'
...
-- cast(T2.NEXT_BILLING_DATE as DATE) as NBD,
T2.NEXT_BILLING_DATE as NBD,
T2.DURATION ,
T2.BILLING_FREQUENCY ,
-- cast(T2.BILL_THROUGH_DATE as DATE) as BTDO,
T2.BILL_THROUGH_DATE as BTDO,
T2.COMMENTS ,
T2.INVOICE_AMT,
